...
|---------------------------|---------------------------------------------------|------|
| **🧩 Run Kraken2 and Bracken** | Run Kraken2 and Bracken (KB) on raw Nanopore data (including *removal of human reads*) |👉 [View](https://github.com/Sinceter/KT-Group-mNGS-Scripts/blob/main/Run_Bracken_and_Kraken2/README.md) |
| **💘 Extract reads from Kraken2** | Extract reads from Kraken2 output and do assembly (optional) for certain species |👉 [View](https://github.com/Sinceter/KT-Group-mNGS-Scripts/blob/main/De_novo_assembly/Extract_reads_README.md) |
...
| **Nanopore reads mapping script** | Mapping Nanopore reads to a reference genome using minimap2 | 👉🏼[View](https://github.com/Sinceter/KT-Group-mNGS-Scripts/blob/main/Nanopore_reads_mapping/README.md) |
