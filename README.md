...
| **Mapping Nanopore reads** | Mapping Nanopore reads to a reference genome using minimap2 | 👉🏼[View](https://github.com/Sinceter/KT-Group-mNGS-Scripts/blob/main/Nanopore_reads_mapping/README.md) |
